...
for j, cnpj in enumerate(cnpjs_beneficiadas):
    ...
    urlcnpj = url + cnpj
    i = 0
    printProgressBar(j + 1, l, prefix = 'Criando arquivos TXT Progresso:', suffix = 'Completo ' + str(j)+ '/' + str(len(cnpjs_beneficiadas)), length = 50)
...
for j, cnpj in enumerate(cnpjs_beneficiadas):
    ...
    printProgressBar(j + 1, l, prefix = 'Organizando dados Progresso:', suffix = 'Completo ' + str(j)+ '/' + str(len(cnpjs_beneficiadas)), length = 50)
